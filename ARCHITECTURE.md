...
This document describes the current architecture of the Form Engine. As the project is still a work in progress, parts of this design may evolve.

---

## Purpose of This Document

This file explains **why** the Form Engine is built the way it is.
...
* symbols exported via `Engine.__init__`
